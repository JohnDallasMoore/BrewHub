...
function Home() {
  return (
    <div>
      <section className="bg-center bg-cover h-screen bg-no-repeat bg-[url('/BeerLineup.jpg')] bg-gray-700 bg-blend-multiply">
          <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
              <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Welcome to BrewHub!</h1>
              <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Discover, rate, and connect with fellow beer enthusiasts. <br /> Cheers to the captivating world of beer! </p>
