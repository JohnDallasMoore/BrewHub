...
function Dashboard() {
  ...
  useEffect(() => {
    // Keep user context state synchronized with token state
      ...
      <aside id="separator-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              <Link to="/dashboard" className="flex items-center text-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                <span className="ml-3 font-bold text-2xl">Brew Central</span>
              </Link>
            </li>

            <li className="border-t border-gray-200 dark:border-gray-700">
              <Link to='/dashboard/all-posts' className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">All Posts</span>
              </Link>
            </li>
            <li>
              <Link to='/dashboard/review' className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
            ...
            <li>
              <Link to='/dashboard/status' className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                  <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z" />
                </svg>
                <span className="flex-1 ml-3 whitespace-nowrap">Statuses</span>
              </Link>
            </li>
            <li>
              <Link to='/dashboard/all-users' className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
...
// Passing props to trigger state changes in children is no longer necessary
function AuthLinks() {
  const { user, logout } = useUserContext()

  const handleLogout = () => {
    // We no longer have to reload the entire document to force component refresh
    logout()
    AuthService.logout()
  }
  ...
  return (
    <div>
      {user.loggedIn ? <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
        <li>
        ...
        <li>
          <Link to='/dashboard/make-review' className="flex items-center p-2 transition duration-75 rounded-lg hover:bg-gray-700 text-white group">
            ...
            <span className="ml-3">Make a Review</span>
          </Link>
        </li>
        <li>
          <Link to='/dashboard/make-status' className="flex items-center p-2 transition duration-75 rounded-lg hover:bg-gray-700 text-white group">
            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
              <path d="M18 0H6a2 2 0 0 0-2 2h14v12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2Z" />
              <path d="M14 4H2a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2ZM2 16v-6h12v6H2Z" />
            </svg>
            <span className="ml-3">Make a Status</span>
          </Link>
        </li>
        <li>
          <Link to='/dashboard/achievements' className="flex items-center p-2 transition duration-75 rounded-lg hover:bg-gray-700 text-white group">
