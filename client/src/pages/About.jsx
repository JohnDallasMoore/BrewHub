    ...
    <div>
      <section id="about" className="bg-gray-800 h-screen">
          <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
              ...
              <div className="hidden lg:ml-24 lg:grid lg:grid-cols-2 lg:gap-4 lg:mt-8">
                  <img className="object-cover w-full h-96 rounded-lg mx-8" src="/Beer-Pour.jpg" alt="Beer Pour" />
