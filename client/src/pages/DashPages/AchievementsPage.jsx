    ...
    <div>
      ...
      <section className="lg:my-4 lg:mx-12  rounded-xl bg-gray-800">
        ...
        <div className='flex justify-center'>
          <a href="#" class="my-8 inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-900">
              See all badges
