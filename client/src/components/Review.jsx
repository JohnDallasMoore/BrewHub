      ...
      <main className="pt-4 pb-8 lg:pt-8 lg:pb-12 max-w-lg">
          <div className="flex justify-between md:px-4 mx-auto max-w-screen-xl ">
              <article className="border-4 rounded-lg p-8 border-gray-900 bg-gray-800 mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                  <header className="mb-2 lg:mb-6 not-format">
                      <address className="flex items-center justify-between mb-6 not-italic">
                          <div className="inline-flex items-center mr-3 text-sm text-white">
                              <div>
                                  <a href="#" rel="author" className="text-md md:text-xl font-bold text-white">Dallas Moore</a>
                                  <p className="text-base text-xs md:text-sm font-light text-gray-400">August 26, 2023</p>
                              </div>
                          </div>
                          <div>
                      ...
                      <h1 className="mb-2 text-xl md:text-3xl font-extrabold leading-tight lg:mb-6 lg:text-2xl text-white"><a href="/posts/{{post.id}}">Social Project - Western Sun IPA</a></h1>
                  </header>
                  ...
                  <br />
                  <figure><img className="mx-auto rounded-md object-contain md:h-96 w-96" src="/beer7.jpeg" alt="" />
                  </figure>
                  <br />
                  <div className="flex items-center">
                      <svg aria-hidden="true" className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Rating star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
                      <p className="ml-2 text-sm font-bold text-white">4.5</p>
