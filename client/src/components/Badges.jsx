    ...
    <div>
        <main className="pt-4 pb-8 lg:pt-8 lg:pb-12 max-w-lg">
          <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
              <article className="border-4 rounded-2xl p-8 border-gray-800 bg-gray-700 mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
